...
# Web scraping of NFL Football player stats
...
def filedownload(df):
    ...
    # Q: Why do we need to encode the csv string into bytes?
    # A: https://stackoverflow.com/questions/6269765/what-does-the-b-character-do-in-front-of-a-string-literal
