...
def style_positive(v, props=''):
    """Style positive values in dataframes"""
    try:
        return props if v > 0 else None
    except:
        pass
...
numeric_cols = np.array((df_agg_diff.dtypes == 'np.float64') | (df_agg_diff.dtypes == 'int64'))
...
if add_sidebar == 'Aggregate Metrics':
    ...
    for i in metric_medians6mo.index:
        with columns[count]:
            delta = (metric_medians6mo[i] - metric_median12mo[i])/metric_median12mo[i]
